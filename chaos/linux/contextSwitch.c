 ...
 *
 * Compile the code - Oct 2020, source - https://github.com/AshrafTaifour/C-context-switch/blob/master/contextSwitch.c
 *
 * gcc contextSwitch.c -o contextswitch
 *
 * Force a lot of context switching in one session
 * $ while [ 1 ] ; do ./contextswitch ; done
 *
 * Monitoring context switches
 * $ vmstat -SM 5
 * $ while [ 1 ]; do cat /proc/stat | egrep "ctxt"; sleep 5; done
 *
*/
#define _GNU_SOURCE
#include <stdio.h>
